...
// 3.0, 4.5, 12.5
// Side length is 20.
unsigned long long cAABB_centre_min::generateID(glm::vec3 minXYZ, float AABBsideLength)
{
	// 3 / 20 --> 0.xx
	...
	return cAABB_centre_min::generateID( minXYZ );
}


unsigned long long cAABB_centre_min::generateID(glm::vec3 minXYZ)
{
...
unsigned long long cAABB_centre_min::getID(void)
{
	// Or you could stror
	return cAABB_centre_min::generateID( this->minXYZ, this->sideLegth );
}
